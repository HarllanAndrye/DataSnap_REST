...
begin
  PersistentClass := ServerMethodsUnit1.Tapi;
end;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := ServerMethodsUnit1.Tapi.ClassName
...
begin
  ...
  Response.SetCustomHeader('Access-Control-Allow-Headers','Accept, Accept-Language, Content-Language, Content-Type, X-Requested-With, authorization, application/json');
  Response.SetCustomHeader('Access-Control-Allow-Methods','GET, POST, DELETE, HEAD, OPTIONS');
  Response.SetCustomHeader('Access-Control-Request-Headers','Content-Type, application/json');
  ...
  ServerMethodsUnit1.vRequest := Request;
